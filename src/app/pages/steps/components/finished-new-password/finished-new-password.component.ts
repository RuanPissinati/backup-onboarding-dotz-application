...
@Component({
  selector: 'app-finished-new-password',
  templateUrl: './finished-new-password.component.html',
  styleUrls: ['./finished-new-password.component.scss']
})
export class FinishedNewPasswordComponent implements OnInit {
