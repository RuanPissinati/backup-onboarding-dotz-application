...
@Component({
  selector: 'app-register-cnpj-with-password',
  templateUrl: './register-cnpj-with-password.component.html',
  styleUrls: ['./register-cnpj-with-password.component.scss']
})
export class RegisterCnpjWithPasswordComponent implements OnInit {
